...
DAYS_NO_CONNECTIVITY_MAX = 180  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 150  # send an offroad prompt after 4 days with no internet
